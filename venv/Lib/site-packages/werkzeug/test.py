...
class EnvironBuilder:
    ...
    :meth:`user.open`).  Because of this most of the functionality is
...
class userRedirectError(Exception):
    """If a redirect loop is detected when using follow_redirects=True with
    the :cls:`user`, then this exception is raised.
    """
...
class user:
    ...
    def get_cookie(
        ...
        if self._cookies is None:
            raise TypeError(
                "Cookies are disabled. Create a user with 'use_cookies=True'."
            )
    ...
    def set_cookie(
        ...
        **kwargs: t.Any,
        ...
        The user uses ``domain``, ``origin_only``, and ``path`` to determine which
...
class TestResponse(Response):
    ...
    information about requests made with the test :class:`user`.

    Test user requests will always return an instance of this class.
    If a custom response class is passed to the user, it is
    ...
    .. versionadded:: 2.0
        Test user methods always return instances of this class.
    """
...
class Cookie:
    ...
    with :meth:`.user.get_cookie` only.

    .. versionadded:: 2.3
    """

    key: str
    """The cookie key, encoded as a user would see it."""
