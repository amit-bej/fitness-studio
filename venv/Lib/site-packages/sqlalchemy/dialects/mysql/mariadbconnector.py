...
It is written in C and uses MariaDB Connector/C user library for user server
communication.
...
class MySQLDialect_mariadbconnector(MySQLDialect):
    ...
    # be unnecessary as MariaDB user libraries have always worked against
    ...
    def create_connect_args(self, url: URL) -> ConnectArgsType:
        ...
        if self.dbapi is not None:
            try:
                ...
                user_flag |= user_FLAGS.FOUND_ROWS
