...
configured on the user machine.   The application then specifies the name
...
is configured on the user, a basic DSN-based connection looks like::
...
can help make this easier::
    ...
    connection_string = "DRIVER={SQL Server Native user 10.0};SERVER=dagger;DATABASE=test;UID=user;PWD=password"
    connection_url = URL.create(
