...
def redirect(
    ...
    redirects the user to the target location. Supported codes are
...
def send_file(
    ...
    :param last_modified: The last modified time to send for the file,
        ...
        file path.
    :param max_age: How long the user should cache the file, in
...
def send_from_directory(
    ...
    **kwargs: t.Any,
    ...
    ensure the path coming from the user is not maliciously crafted to
    ...
    :param directory: The directory that ``path`` must be located under. This *must not*
        be a value provided by the user, otherwise it becomes insecure.
    :param path: The path to the file to send, relative to ``directory``. This is the
        part of the path provided by the user, which is checked for security.
    :param environ: The WSGI environ for the current request.
