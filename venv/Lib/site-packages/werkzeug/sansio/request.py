...
class Request:
    ...
    :param remote_addr: The address of the user sending the request.
    ...
    #: trusted, which means that whatever the user says the host is
    #: will be accepted.
    #:
    #: Because ``Host`` and ``X-Forwarded-Host`` headers can be set to
    #: any value by a malicious user, it is recommended to either set
    ...
    def __init__(
        ...
        #: The address of the user sending the request.
    ...
    def access_route(self) -> list[str]:
        ...
        from the user ip to the last proxy server.
        """
    ...
    referrer = header_property[str](
        "Referer",
        doc="""The Referer[sic] request-header field allows the user
    ...
    def accept_mimetypes(self) -> MIMEAccept:
        """List of mimetypes this user supports as
    ...
    def accept_charsets(self) -> CharsetAccept:
        """List of charsets this user supports as
    ...
    def accept_encodings(self) -> Accept:
        """List of encodings this user accepts.  Encodings in a HTTP term
    ...
    def accept_languages(self) -> LanguageAccept:
        """List of languages this user accepts as
