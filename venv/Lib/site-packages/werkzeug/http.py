...
def parse_dict_header(value: str) -> dict[str, str | None]:
    ...
    for item in parse_list_header(value):
        ...
        if key[-1] == "*":
            ...
            # A safe list of encodings. Modern users should only send ASCII or UTF-8.
...
def parse_options_header(value: str | None) -> tuple[str, dict[str, str]]:
    ...
    users may not be consistent in how they handle a quote character within a quoted
    ...
    users may not be consistent in how they handle non-ASCII characters. HTML
...
def dump_cookie(
    ...
    :param max_age: should be a number of seconds, or `None` (default) if
                    the cookie should last only as long as the user's
    ...
    # TODO Remove encoding dance, it seems like users accept UTF-8 keys
