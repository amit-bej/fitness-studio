...
class WSGIRequestHandler(BaseHTTPRequestHandler):
    ...
    def make_environ(self) -> WSGIEnvironment:
        ...
        if not self.user_address:
            self.user_address = ("<local>", 0)
        elif isinstance(self.user_address, str):
            self.user_address = (self.user_address, 0)
        ...
        try:
            ...
            if peer_cert is not None:
                ...
                environ["SSL_user_CERT"] = ssl.DER_cert_to_PEM_cert(peer_cert)
        except ValueError:
    ...
    def run_wsgi(self) -> None:
        ...
        def execute(app: WSGIApplication) -> None:
            ...
            try:
                ...
                # will read past request.max_content_length, but lets the user see a
                ...
                # A timeout of 0 tends to fail because a user needs a small amount of
                ...
                while selector.select(timeout=0.01):
                    ...
                    # Stop reading on no data, >=10GB, or 1000 reads. If a user sends
    ...
    def connection_dropped(
        ...
        """Called if the connection was closed by the user.  By default
        nothing happens.
        """
    ...
    def address_string(self) -> str:
        ...
        return self.user_address[0]

    def port_integer(self) -> int:
        return self.user_address[1]
...
class BaseWSGIServer(HTTPServer):
    ...
    def handle_error(
        self, request: t.Any, user_address: tuple[str, int] | str
    ) -> None:
        if self.passthrough_errors:
            raise

        return super().handle_error(request, user_address)
